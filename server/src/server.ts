...
import { convertMinutesToHorsString } from './utils/conver-minutes-to-hours-string';
...
app.get('/games/:id/ads', async (req, res) => {
  ...
  return res.json(ads.map(ad => {
    return {
      ...
      hoursStart: convertMinutesToHorsString(ad.hoursStart),
      hoursEnd: convertMinutesToHorsString(ad.hoursEnd),
    }
  }));
});
